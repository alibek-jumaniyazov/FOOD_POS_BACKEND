...
let categories = {
  hotdishes: [
    { id: 1, title: "Spicy seasoned seafood noodles", price: 2.29, availability: "20 Bowls available" },
    { id: 2, title: "Spicy beef ramen", price: 3.49, availability: "15 Bowls available" },
  ],
  colddishes: [
    { id: 3, title: "Cold sushi rolls", price: 2.69, availability: "10 Rolls available" },
  ],
};
...
app.put("/products/:category/:id", (req, res) => {
  ...
  if (!categories[category]) return res.status(404).json({ message: "Category not found" });
...
app.post("/cart", (req, res) => {
  const { title, price, count, note } = req.body;
